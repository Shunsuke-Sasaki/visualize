...
with PdfPages(pdf_path) as pdf:
    ...
    for key in ['Interpolation', 'Extrapolation']:
        all_values = np.array(
        ...
        for model in csv_files:
            ...
            rmse_values[model][f'{key} Variance'] = (
                np.array(rmse_values[model][f'{key} Variance']) / range_vals
            )
    ...
    ax.set_title('Normalized RMSE Comparison Across Targets', fontsize=22)
